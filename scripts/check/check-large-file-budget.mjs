...
const HARD_LIMIT_REGISTRY = Object.freeze([
  ...
  { path: 'src/service/control-plane-store.ts', maxLines: 4258, reason: 'P2 store-family split in progress; schema SQL extracted, compatibility facade must keep shrinking.' },
