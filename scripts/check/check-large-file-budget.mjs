...
const HARD_LIMIT_REGISTRY = Object.freeze([
  ...
  { path: 'src/service/http/routes/shadow-routes.ts', maxLines: 2979, reason: 'P2 route-family split in progress; summary/dashboard/audit routes extracted while route ordering and shadow audit behavior remain under dedicated coverage.' },
