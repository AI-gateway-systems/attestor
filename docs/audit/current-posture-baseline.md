...
| `ops/**` audit gap | partial | not proven / live-proof-only for remediated slices | OPS-SWEEP-01 through OPS-SWEEP-07 are indexed; profile/provider/live-proof capture has repo-side hardening, while live cloud proof remains incomplete. | Continue ops audit and capture live proof before live shadow. |
