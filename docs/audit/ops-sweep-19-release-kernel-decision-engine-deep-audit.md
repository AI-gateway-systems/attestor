...
| OPS-152 resource budget | Adds adversarial boundedness around deterministic checks | low | adversarial-size test if exposed route accepts large observation arrays |
