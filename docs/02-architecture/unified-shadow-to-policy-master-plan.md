...
- Canonical event and provenance shape: [CloudEvents specification](https://github.com/cloudevents/spec), [OpenTelemetry Logs Data Model](https://opentelemetry.io/docs/specs/otel/logs/data-model/), [Open Cybersecurity Schema Framework](https://schema.ocsf.io/), [W3C PROV Data Model](https://www.w3.org/TR/prov-dm/), and [OPA decision logs](https://www.openpolicyagent.org/docs/management-decision-logs).
