...
System metadata can help Attestor find where consequences are forming. The
...
[See system metadata become a gate plan](docs/02-architecture/runtime-signal-handling.md#local-example)
