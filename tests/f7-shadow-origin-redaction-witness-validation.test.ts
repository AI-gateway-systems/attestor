...
try {
  ...
  includes(tracker, '| F7 shadow infrastructure red-team | 10 | 3 | 5 | 2 |', 'Tracker: F7 count is updated after witness slice');
  includes(tracker, 'Remaining F7 queue after shadow origin and redaction witness: 5 planned', 'Tracker: F7 remaining count is updated');
