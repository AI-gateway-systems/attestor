...
function testDocsAndScriptsExposeStep12(): void {
  ...
  includes(masterPlan, '| Complete | 19 |', 'Unified plan: Step 19 completion count is updated');
  includes(masterPlan, '| Remaining | 7 |', 'Unified plan: remaining count moves to 7');
