...
function testDocsAndScriptsExposeStep12(): void {
  ...
  includes(masterPlan, '| Complete | 25 |', 'Unified plan: Step 23 completion count is updated');
  includes(masterPlan, '| Remaining | 1 |', 'Unified plan: remaining count moves to 3');
