...
function testDocsAndScriptsExposeStep12(): void {
  ...
  includes(masterPlan, '| Complete | 14 |', 'Unified plan: Step 14 completion count is updated');
  includes(masterPlan, '| Remaining | 12 |', 'Unified plan: remaining count moves to 12');
