...
function testTopLevelPositioningStaysAligned(): void {
  ...
  includes(readme, 'Attestor is an AI Action Control Plane that sits between AI intent and real-world consequence.', 'Product docs: README keeps AI Action Control Plane framing');
