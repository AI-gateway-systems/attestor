...
function testReadmeLinksTheRightDeeperDocsWithoutBecomingALinkWall(): void {
  ...
  includes(readme, '[Run Attestor in shadow pilot mode](docs/01-overview/shadow-event-payload-examples.md) - send observe-mode examples before enforcing anything.', 'Product docs: README links observe mode as a main onboarding path');
