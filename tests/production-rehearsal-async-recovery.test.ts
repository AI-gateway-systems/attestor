...
function testDocsAndPackageWireTheRehearsal(): void {
  ...
  includes(tracker, '| Completed | 7 |', 'Production async recovery: tracker marks seven steps complete');
  includes(tracker, '| Not started | 3 |', 'Production async recovery: tracker leaves three steps pending');
  ...
  includes(tracker, 'Implement Step 08: rehearse backup, restore, and DR.', 'Production async recovery: immediate next step advances to Step 08');
